...
const translations = {
    'zh-CN': {
        ...
        'modal.provider.detectedModelsNewBadge': '新落盘',
        'modal.provider.detectedModelsNewTip': '本次检测发现的新模型，已写入 custom_models.json，"模型测试"等位置立即可用',
        'modal.provider.detectModelsPersisted': '已落盘 {count} 个新模型到 custom_models.json',
    ...
    'en-US': {
        ...
        'modal.provider.detectedModelsNewTip': 'Newly discovered model; persisted to custom_models.json so it\'s usable in Model Playground immediately',
        'modal.provider.detectModelsPersisted': 'Persisted {count} new models to custom_models.json',
