...
const translations = {
    'zh-CN': {
        ...
        'oauth.kiro.awsImportInstructions': '请上传 AWS SSO cache 目录中的 JSON 文件，必填字段为 clientId、clientSecret、refreshToken；accessToken 可留空，导入时会用 refreshToken 自动获取。如果是AWS企业用户，需增加 idcRegion 字段。',
        ...
        'oauth.kiro.awsJsonPlaceholderSimple': '在此粘贴包含 clientId、clientSecret、refreshToken 的 JSON（accessToken 可留空）...',
        ...
        'config.kiro.baseUrlPlaceholder': 'https://runtime.{{region}}.kiro.dev/generateAssistantResponse',
        ...
        'config.advanced.systemPromptMode.head': '头部 (head)',
        ...
        'modal.provider.detectModelsHelp': '从该账号上游拉取最新模型，并合并到候选列表中',
        'modal.provider.detectModelsSuccess': '已合并模型，共 {total} 个候选（新增 {added} 个）',
        'modal.provider.detectedModelsTitle': '{type} 上游模型',
        'modal.provider.detectedModelsSummary': '共 {total} 个，匹配 {visible} 个，其中已禁用 {disabled} 个，本次新增 {new} 个',
        'modal.provider.detectedModelsCopy': '复制全部',
        'modal.provider.detectedModelsCopied': '已复制 {count} 行到剪贴板',
        'modal.provider.detectedModelsEnabledBadge': '可用',
        'modal.provider.detectedModelsDisabledBadge': '已禁用',
        'modal.provider.detectedModelsDisabledTip': '该模型已被加入此节点的 notSupportedModels 黑名单',
        'modal.provider.detectedModelsNewBadge': '新增',
        'modal.provider.detectedModelsNewTip': '本次检测相对此前已知清单新出现的模型，已写入检测缓存，"模型测试"等位置立即可用',
        'modal.provider.detectModelsPersisted': '已更新检测缓存，本次新增 {count} 个模型',
        'modal.provider.modelPickerNoMatch': '没有匹配的模型',
        ...
        'modal.provider.field.accountProxyUrl': '账号代理 URL',
        'modal.provider.field.accountProxyDisabled': '强制禁用代理',
        'modal.provider.field.accountFingerprint': '浏览器指纹 (JSON)',
        ...
        'tutorial.main.prompt.replacements': '系统提示文本替换规则，每项含 old/new 字段',
        ...
        'tutorial.main.retry.rateLimitCooldownJitter': '冷却时间随机抖动上限（毫秒），避免同时恢复',
        'tutorial.main.retry.rateLimitCooldownMax': '冷却时间上限（毫秒）',
        'tutorial.main.retry.error': '提供商最大错误次数，超过后标记为不健康',
        'tutorial.main.governance.cronNear': '凭证临近过期多少分钟内触发自动刷新',
        'tutorial.main.governance.cronRefresh': '是否启用定时自动刷新 Token',
        ...
        'tutorial.main.paths.title': '文件路径配置',
        'tutorial.main.paths.pools': '提供商池配置文件路径',
        'tutorial.main.paths.custom': '自定义模型配置文件路径',
        'tutorial.main.paths.detected': '模型自动检测结果缓存文件路径',
        ...
        'tutorial.main.log.level': '日志级别 (debug/info/warn/error)',
        'tutorial.main.log.dir': '日志文件存放目录',
        'tutorial.main.log.maxSize': '单个日志文件最大字节数，超过后轮转',
        'tutorial.main.log.maxFiles': '保留的日志文件数量上限',
        'tutorial.log.example.title': '配置示例',
        'tutorial.main.basic.uiEnabled': '是否启用 Web UI 控制台',
        'tutorial.main.log.promptBaseName': '提示词日志文件基础名称',
        'tutorial.main.log.includeRequestId': '日志中是否包含请求 ID',
        'tutorial.main.log.includeTimestamp': '日志中是否包含时间戳',
        'tutorial.advanced.title': '高级调优',
        'tutorial.advanced.desc': '以下为可选的进阶配置，省略时全部走安全默认值。除非有明确需求，否则无需设置。',
        'tutorial.advanced.kiro.title': 'Kiro 模型能力 (KIRO_MODEL_CAPABILITIES)',
        'tutorial.advanced.kiro.desc': '按 model-id 控制 claude-kiro-oauth 的行为。key 可用上游 id (如 claude-opus-4.7) 或客户端 id；default 作用于所有未单列模型，per-model 优先级更高。整体省略则全部走版本默认。',
        'tutorial.advanced.kiro.nativeThinking': '是否下发 additionalModelRequestFields(thinking)。省略时按版本自动判定 (Claude >= 4.7；4.5/4.6 会返回 400，故自动跳过)',
        'tutorial.advanced.kiro.contextCompression': 'false 时对该模型跳过工具结果截断 + 工具描述自适应缩短 (适合 1M 上下文模型)，省略时默认 true',
        'tutorial.advanced.kiroOther.title': 'Kiro 输出/上下文调优',
        'tutorial.advanced.kiro.tokenBuffer': '历史裁剪的 token 缓冲预留，裁剪上限 = 模型上下文 - 该值；取值会被 clamp 到 [5000, 150000]',
        'tutorial.advanced.kiro.contextPressure': '上下文压力系数，用于缓解输出截断',
        'tutorial.advanced.kiro.toolTruncate': '是否截断过长的工具结果',
        'tutorial.advanced.kiro.toolMaxChars': '工具结果截断时保留的最大字符数',
        'tutorial.advanced.kiro.toolDescAdaptive': '是否对工具描述进行自适应缩短',
        'tutorial.advanced.kiro.note': '以上 OUTPUT_RESERVE_* 默认全部关闭，仅作用于 claude-kiro-oauth provider，用于缓解输出被截断的问题。',
        'tutorial.advanced.tls.title': 'TLS Sidecar',
        'tutorial.advanced.tls.enabled': '是否启用 TLS sidecar 代理',
        'tutorial.advanced.tls.port': 'TLS sidecar 监听端口',
        'tutorial.grok.title': 'Grok 鉴权配置',
        'tutorial.grok.desc': '使用 Grok 提供商时，需从浏览器中提取 Cookie 等鉴权信息：',
        'tutorial.grok.cookie': 'Grok SSO Cookie token',
        'tutorial.grok.cfClearance': 'Cloudflare cf_clearance Cookie',
        'tutorial.grok.userAgent': '与 Cookie 匹配的浏览器 User-Agent',
        'tutorial.grok.baseUrl': 'Grok 服务地址，默认 https://grok.com',
    ...
    'en-US': {
        ...
        'oauth.kiro.awsImportInstructions': 'Upload JSON files from AWS SSO cache directory. Required fields: clientId, clientSecret, refreshToken. accessToken is optional and will be fetched automatically via refreshToken if left empty. For AWS enterprise users, add the idcRegion field.',
        ...
        'oauth.kiro.awsJsonPlaceholderSimple': 'Paste JSON containing clientId, clientSecret, refreshToken here (accessToken optional)...',
        ...
        'config.advanced.systemPromptMode.head': 'Head',
        ...
        'modal.provider.detectModelsHelp': 'Fetch the latest models from this account and merge them into the candidate list',
        'modal.provider.detectModelsSuccess': 'Models merged: {total} candidates total ({added} new)',
        'modal.provider.detectedModelsTitle': '{type} Upstream Models',
        'modal.provider.detectedModelsSummary': '{total} total, {visible} matching, {disabled} disabled, {new} newly persisted',
        'modal.provider.detectedModelsCopy': 'Copy All',
        'modal.provider.detectedModelsCopied': 'Copied {count} lines to clipboard',
        'modal.provider.detectedModelsEnabledBadge': 'Available',
        'modal.provider.detectedModelsDisabledBadge': 'Disabled',
        'modal.provider.detectedModelsDisabledTip': 'This model is in this node\'s notSupportedModels list',
        'modal.provider.detectedModelsNewBadge': 'New',
        'modal.provider.detectedModelsNewTip': 'Newly appeared model vs. the previously known list; written to the detection cache and usable in Model Playground immediately',
        'modal.provider.detectModelsPersisted': 'Detection cache updated, {count} new models this run',
        'modal.provider.modelPickerNoMatch': 'No matching models',
        ...
        'modal.provider.field.accountProxyUrl': 'Account Proxy URL',
        'modal.provider.field.accountProxyDisabled': 'Disable Proxy (force direct)',
        'modal.provider.field.accountFingerprint': 'Browser Fingerprint (JSON)',
        'modal.provider.field.cfClearance': 'CF Clearance (Cookie)',
        ...
        'tutorial.main.prompt.replacements': 'System prompt text replacement rules, each with old/new fields',
        ...
        'tutorial.main.retry.rateLimitCooldownJitter': 'Max random jitter for cooldown (milliseconds), avoids simultaneous recovery',
        'tutorial.main.retry.rateLimitCooldownMax': 'Upper limit for cooldown duration (milliseconds)',
        'tutorial.main.retry.error': 'Max provider error count before marking unhealthy',
        'tutorial.main.governance.cronNear': 'Auto-refresh triggers when credentials are this many minutes from expiry',
        'tutorial.main.governance.cronRefresh': 'Whether to enable scheduled automatic token refresh',
        ...
        'tutorial.main.paths.title': 'File Path Configuration',
        'tutorial.main.paths.pools': 'Provider pool config file path',
        'tutorial.main.paths.custom': 'Custom models config file path',
        'tutorial.main.paths.detected': 'Auto-detected models result cache file path',
        ...
        'tutorial.main.log.level': 'Log level (debug/info/warn/error)',
        'tutorial.main.log.dir': 'Directory for log files',
        'tutorial.main.log.maxSize': 'Max bytes per log file before rotation',
        'tutorial.main.log.maxFiles': 'Maximum number of log files to retain',
        'tutorial.log.example.title': 'Configuration Example',
        'tutorial.main.basic.uiEnabled': 'Whether to enable the Web UI console',
        'tutorial.main.log.promptBaseName': 'Base name for prompt log files',
        'tutorial.main.log.includeRequestId': 'Whether to include request ID in logs',
        'tutorial.main.log.includeTimestamp': 'Whether to include timestamp in logs',
        'tutorial.advanced.title': 'Advanced Tuning',
        'tutorial.advanced.desc': 'The following are optional advanced settings. All fall back to safe defaults when omitted. No need to set them unless you have a specific requirement.',
        'tutorial.advanced.kiro.title': 'Kiro Model Capabilities (KIRO_MODEL_CAPABILITIES)',
        'tutorial.advanced.kiro.desc': 'Control claude-kiro-oauth behavior per model-id. Keys can be upstream ids (e.g. claude-opus-4.7) or client ids; "default" applies to all unlisted models, and per-model entries take priority. Omit entirely to use version defaults for all.',
        'tutorial.advanced.kiro.nativeThinking': 'Whether to send additionalModelRequestFields(thinking). When omitted, decided by version (Claude >= 4.7; 4.5/4.6 return 400, so auto-skipped)',
        'tutorial.advanced.kiro.contextCompression': 'When false, skip tool-result truncation + adaptive tool-description shortening for this model (suited to 1M-context models); defaults to true when omitted',
        'tutorial.advanced.kiroOther.title': 'Kiro Output/Context Tuning',
        'tutorial.advanced.kiro.tokenBuffer': 'Token buffer reserve for history trimming. Trim limit = model context - this value; clamped to [5000, 150000]',
        'tutorial.advanced.kiro.contextPressure': 'Context pressure coefficient, used to mitigate output truncation',
        'tutorial.advanced.kiro.toolTruncate': 'Whether to truncate overly long tool results',
        'tutorial.advanced.kiro.toolMaxChars': 'Max characters retained when truncating tool results',
        'tutorial.advanced.kiro.toolDescAdaptive': 'Whether to adaptively shorten tool descriptions',
        'tutorial.advanced.kiro.note': 'All OUTPUT_RESERVE_* options above are disabled by default and only apply to the claude-kiro-oauth provider, used to mitigate output truncation.',
        'tutorial.advanced.tls.title': 'TLS Sidecar',
        'tutorial.advanced.tls.enabled': 'Whether to enable the TLS sidecar proxy',
        'tutorial.advanced.tls.port': 'TLS sidecar listening port',
        'tutorial.grok.title': 'Grok Authentication',
        'tutorial.grok.desc': 'When using the Grok provider, extract cookies and other auth info from your browser:',
        'tutorial.grok.cookie': 'Grok SSO cookie token',
        'tutorial.grok.cfClearance': 'Cloudflare cf_clearance cookie',
        'tutorial.grok.userAgent': 'Browser User-Agent matching the cookies',
        'tutorial.grok.baseUrl': 'Grok service URL, defaults to https://grok.com',
