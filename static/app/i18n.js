...
const translations = {
    'zh-CN': {
        ...
        'modal.provider.detectedModelsSummary': '共 {total} 个，匹配 {visible} 个，其中已禁用 {disabled} 个',
    ...
    'en-US': {
        ...
        'modal.provider.detectedModelsSummary': '{total} total, {visible} matching, {disabled} disabled',
